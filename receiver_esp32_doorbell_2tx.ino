 ...
 * ============================================
 * 
 * Firmware versie: 2.0 - 2026-05-24
 * Ondersteunt: RING en PONG signalen
 * 
...
// PONG Melodie: (tweemaal, binnen 2 seconden)
...
void setup() {
    ...
    Serial.println();
    Serial.println("========================================");
    Serial.println("   ESP32 Deurbel Ontvanger v2.0        ");
    Serial.println("   Ondersteunt: RING en PONG            ");
    Serial.println("========================================");
